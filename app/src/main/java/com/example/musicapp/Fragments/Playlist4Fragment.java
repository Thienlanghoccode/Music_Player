...
public class Playlist4Fragment extends Fragment {

    private static final String TAG = "Playlist4Fragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_playlist4, container, false);
    ...
    private void loadPlaylistData() {
        viewModel.getSections().observe(getViewLifecycleOwner(), sections -> {
            ...
            List<Song> songs = sections.getOrDefault("top_songs_global", new ArrayList<>());
            playlistSongs.clear();
            assert songs != null;
    ...
    private void setupPlayButton() {
        btnPlay.setOnClickListener(v -> {
            if (!playlistSongs.isEmpty()) {
                ...
                navController.navigate(R.id.action_playlist4Fragment_to_musicPlayerFragment, bundle);
            }
        });
    }
